...
namespace TestimonialWebApp.ApplicationService {
    ...
    public partial class ApplicationService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// CodeRemarks
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("dse.webservices/getApplicationStatus", RequestNamespace="dse.webservices", ResponseNamespace="dse.webservices", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public ValueTupleOfInt32Boolean getApplicationStatus(string regNum, string transacNum) {
            object[] results = this.Invoke("getApplicationStatus", new object[] {
                        regNum,
                        transacNum});
            return ((ValueTupleOfInt32Boolean)(results[0]));
        }
        
        /// CodeRemarks
        public void getApplicationStatusAsync(string regNum, string transacNum) {
            this.getApplicationStatusAsync(regNum, transacNum, null);
        }
        
        /// CodeRemarks
        public void getApplicationStatusAsync(string regNum, string transacNum, object userState) {
            ...
            this.InvokeAsync("getApplicationStatus", new object[] {
                        regNum,
                        transacNum}, this.getApplicationStatusOperationCompleted, userState);
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="dse.webservices")]
    public partial class ValueTupleOfInt32Boolean {
    ...
    public partial class getApplicationStatusCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// CodeRemarks
        public ValueTupleOfInt32Boolean Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((ValueTupleOfInt32Boolean)(this.results[0]));
            }
        }
    }
}
